...
stat_file = r"stats" + os.sep + "autojoin_grid_search"+model_name+".csv"

stats_df = pd.DataFrame(columns = ["threshold", "model_name", "avg_pr", "avg_recall", "avg_f1", "total_time"])
# %%
# texts1_list = ["Berlinn", "Toronto", "Barcelona"]
# texts2_list = ["Toronto", "Boston", "Berlin", "Barcelona"]
# texts3_list = ["Berlin", "barcelna", "Boston"]
for current_threshold in range(1, 11):
    ...
    for integration_set in benchmark_integration_sets:
        ...
        for second_column in all_columns:
            ...
            matching_results, combined_embeddings, unmatched_texts1, unmatched_texts2 = apply_bipartite_matching_simple(average_embeddings_1, average_embeddings_2, texts1, texts2, threshold = current_threshold)
    ...
    # ["threshold", "model_name", "avg_pr", "avg_recall", "avg_f1", "total_time"]
    # %%
